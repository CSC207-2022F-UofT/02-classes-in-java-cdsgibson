...
public class Silly implements Comparable<Silly>{
     ...
     *
     * Creates a new Silly object from the concatenation of two Strings.
     * This constructor takes in two Strings as arguments.
     *
     * @param name1 a string for the first part of this Silly instance's name.
     * @param name2 a string for the second part of this Silly instance's name.
     */
